...
class MatchSelectionScreen extends StatefulWidget {
  ...
  @override
  State<MatchSelectionScreen> createState() => MatchSelectionScreenState();
}

class MatchSelectionScreenState extends State<MatchSelectionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Send Match to Chat'),
        actions: [
          IconButton(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Open the match creation screen to set up a new fixture.',
