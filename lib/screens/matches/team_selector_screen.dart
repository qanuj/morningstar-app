...
class TeamSelectorScreen extends StatefulWidget {
  ...
  static Future<Team?> showTeamPicker({
    required BuildContext context,
    required String title,
    String? clubId,
    bool Function(Team team)? filterTeams,
  }) async {
    return await showModalBottomSheet<Team>(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => TeamSelectorModal(
        title: title,
        clubId: clubId,
  ...
  // Static method for multi-select
  static Future<List<Team>?> showMultiTeamPicker({
    required BuildContext context,
    required String title,
    String? clubId,
    bool Function(Team team)? filterTeams,
    ...
    return await showModalBottomSheet<List<Team>>(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => TeamSelectorModal(
...
// New Modal Widget for Team Selector
class TeamSelectorModal extends StatefulWidget {
  final String title;
  final String? clubId;
  final bool Function(Team team)? filterTeams;
  final bool multiSelect;
  ...
  @override
  State<TeamSelectorModal> createState() => _TeamSelectorModalState();
}
...
class _TeamSelectorModalState extends State<TeamSelectorModal>
    with SingleTickerProviderStateMixin {
  late TabController _tabController;
  final TextEditingController _searchController = TextEditingController();
  List<Team> _searchResults = [];
  ...
  Future<void> _scanQRCode() async {
    try {
      ...
      if (qrData != null && mounted) {
        ...
        if (parsedTeam != null) {
          // Return the team and close the modal
          Navigator.of(context).pop(parsedTeam);
        } else {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('QR code does not contain valid team information'),
