      ...
      builder: (context, userProvider, themeProvider, child) {
        ...
        return Scaffold(
          ...
          appBar: DuggyAppBar(
            ...
            actions: [
              IconButton(
                onPressed: () => _showMemberQRCode(context, user),
...
Download now and transform your cricket club experience!''';
  ...
  void _showMemberQRCode(BuildContext context, User? user) {
    if (user != null) {
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => MemberQRScreen(user: user)),
      );
    }
  }
}
