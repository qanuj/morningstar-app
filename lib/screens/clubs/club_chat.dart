...
class ClubChatScreenState extends State<ClubChatScreen>
  ...
  Future<void> _handleReactionAdded(ClubMessage message, String emoji) async {
    ...
    // Optimistically add the reaction for immediate UI feedback
    setState(() {
      ...
      if (messageIndex != -1) {
        ...
        _messages[messageIndex] = message.copyWith(reactions: updatedReactions);
        debugPrint(
          '✅ Updated message reactions: ${updatedReactions.length} reactions total',
        );
      }
    });
    ...
    try {
      ...
      debugPrint('✅ Reaction added successfully from message bubble');
    } catch (e) {
      debugPrint('❌ Error adding reaction from message bubble: $e');
